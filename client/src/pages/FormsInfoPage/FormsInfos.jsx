  ...
  return (
    <div>
      <Container sx={{ display: 'flex', justifyContent: 'center', marginTop: 4 }}>
        <Box sx={{ backgroundColor: '#c4bfac', borderRadius: 5, padding: 2, width: 1200 }}>
          <Container sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
            ...
            <Typography className="FormResult" component="div" sx={{ fontWeight: 700, fontSize: 30, marginRight: 10, border: 2, borderRadius: 3, padding: 2, backgroundColor: '#A8A599', fontWeight: 700 }}>
              Result
            </Typography>
          </Container>
        </Box>
      ...
      <Container sx={{ display: 'flex', justifyContent: 'center', marginTop: 3 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 2, minWidth: 50, backgroundColor: '#BAB9AF', cursor:"pointer" }}>
            <svg
